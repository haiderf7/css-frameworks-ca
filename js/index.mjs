...
function handleSearchPredefinedPosts() {
  ...
  let filteredPosts = preDefinedPosts.filter((post) => post.content.toLowerCase().includes(searchValue?.toLowerCase()) || post.author.toLowerCase().includes(searchValue?.toLowerCase()));
